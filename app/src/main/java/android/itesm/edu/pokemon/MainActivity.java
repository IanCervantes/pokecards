...
import android.itesm.edu.pokemon.RecycleViewAdapter.RecycleViewAdapter;
...
public class MainActivity extends AppCompatActivity {
                    ...
                    public void onResponse(JSONObject response) {
                        try{
                            ...
                            for (int i = 0; i < cardsJSON.length(); i++){
                                ...
                                pokeCard.setAuthor(jsonObject.getString("artist"));

                                Log.i("salida", pokeCard.getName());
    ...
    private void setRecyclerView(List<PokeCard> pokeCards){
        RecycleViewAdapter pokemonRecycleAdapter = new RecycleViewAdapter(this,pokeCards);
